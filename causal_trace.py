...
# ATTRIBUTION NOTICE
# ==============================================================================
# Portions of this code are based on or derived from the MEMIT project,
# available at: https://github.com/kmeng01/memit/tree/main
#
# The original MEMIT project is licensed under the MIT License.
# A copy of the MIT License as applied to the original project can typically
...
from utils.generate_graphs import plot
from utils import nethook
from utils.runningstats import Covariance, tally
...
if __name__=='__main__':
    ...
    parser.add_argument('--fact_file', type=str, default="known_QA_T2.json", help='location for fact file')
    ...
    noise_level = parse_noise_rule("s3")
    replace=0
    ...
    for knowledge in tqdm(knowns):
        ...
        for kind in None, "mlp", "self_attn":
            ...
            pdfname = f'{pdf_dir}/{str(numpy_result["answer"]).strip()}_{known_id}{kind_suffix}.jpeg'
            if known_id > 200:
                continue
